...
EMOJI = {
    "star": "⭐", "vip": "👑", "gem": "💎", "sparkles": "✨",
    "wallet": "👛", "deposit": "📥", "withdraw": "📤", "support": "👨‍💻",
    "admin": "⚙️", "money": "💸", "fire": "🔥", "target": "🎯",
    "check": "✅", "cross": "❌", "clock": "⏳", "rocket": "🚀",
    "lightning": "⚡", "stats": "📈", "broadcast": "📢", "qr": "🖼",
    "off": "🔴", "on": "🟢", "info": "ℹ️", "key": "🔑"
}
...
if __name__ == "__main__":
    ...
    logger.info("🚀 Запускаю кассу в режиме POLLING...")
    while True:
        try:
